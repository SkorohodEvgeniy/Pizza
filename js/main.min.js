...
$(document).ready(function () {
  $(".category-slider").slick({
    ...
    slidesToScroll: 2,
    prevArrow:
      '<button type="button" class="article-slider__arrow article-slider__arrowLeft"><img src="img/svg/arrow-l.svg" alt="arrow-l" class="arrow-l" /></button>',
    nextArrow:
      '<button type="button" class="article-slider__arrow article-slider__arrowRight"><img src="img/svg/arrow-r.svg" alt="arrow-r" class="arrow-r" /></button>',
  });

  $(".tab__reviews-slider").slick({
    slidesToShow: 2,
    slidesToScroll: 1,
    autoplay: true,
  });
  $('button[data-toggle="tab"]').on("shown.bs.tab", function (e) {
    $(".tab__reviews-slider").slick("setPosition");
  });
...
$("#pills-tab-pickup button#pills-home-tab").on("click", function (event) {
  event.preventDefault();
  $(".total-pay").removeClass("pick");
  $(".total-pay").addClass("deliv");
});
$("#pills-tab-pickup button#pills-profile-tab").on("click", function (event) {
  event.preventDefault();
  $(".total-pay").removeClass("deliv");
  $(".total-pay").addClass("pick");
});
